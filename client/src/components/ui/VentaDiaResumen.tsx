...
export function VentasDiaResumen ({ venta, aspiracion }: VentasDiaResumenProps) {
  return (
    <article className='gap-4 py-3 flex flex-col rounded-md justify-around dark:text-white bg-slate-50 border dark:bg-slate-900 dark:border dark:border-gray-500 2xl:py-6'>

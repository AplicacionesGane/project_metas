...
const progressCircleVariants = tv({
  ...
  variants: {
    variant: {
      ...
      warning: {
        background: 'stroke-yellow-100 dark:stroke-yellow-500/30',
        circle: 'stroke-yellow-500 dark:stroke-yellow-500',
      },
      error: {
        background: 'stroke-red-100 dark:stroke-red-500/30',
      ...
      success: {
        background: 'stroke-emerald-100 dark:stroke-emerald-500/30',

...
import { Productos } from './productospwbi';

export class Ventaxhoras extends Model<InferAttributes<Ventaxhoras>, InferCreationAttributes<Ventaxhoras>> {
...
Ventaxhoras.belongsTo(Productos, {
